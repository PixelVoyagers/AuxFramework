...
abstract class ComponentFactory {
    ...
    open fun getComponentDefinitions(type: Class<*>) = getAllComponents().filter { it.type == type.kotlin || it.type.isSubclassOf(type.kotlin) || (it.isInitialized() && type.isInstance(it.cast())) }
